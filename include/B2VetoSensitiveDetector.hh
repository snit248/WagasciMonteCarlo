...
#ifndef WAGASCIBABYMINDMONTECARLO_B2VETOSENSITIVEDETECTOR_HH
#define WAGASCIBABYMINDMONTECARLO_B2VETOSENSITIVEDETECTOR_HH
...
/**
 * Class describing veto scintillator bars and their hits
 */
class B2VetoSensitiveDetector : public B2SensitiveDetector {
...
public:
   ...
   */
  explicit B2VetoSensitiveDetector(const G4String &name, const B2Dimension &dimension);
};


#endif //WAGASCIBABYMINDMONTECARLO_B2VETOSENSITIVEDETECTOR_HH
