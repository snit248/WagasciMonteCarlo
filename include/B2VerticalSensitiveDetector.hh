...
/**
 * Class describing vertical scintillator bars and their hits
 */
class B2VerticalSensitiveDetector : public B2SensitiveDetector {
...
public:
   ...
   */
  explicit B2VerticalSensitiveDetector(const G4String &name, const B2Dimension &dimension);
};
